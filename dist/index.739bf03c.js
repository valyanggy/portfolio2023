...
].forEach((preview)=>previews.push(new (0, _preview.Preview)(preview)));
// Item instances array
const items = [];
[
    ...document.querySelectorAll(".item")
].forEach((item, pos)=>items.push(new (0, _item.Item)(item, previews[pos])));
const openItem = (item)=>{
    ...
    .to([
        ...
        (0, _gsap.gsap).set(item.preview.DOM.multiLineWrap, {
            opacity: 1,
            delay: 0.1
        });
    ...
    .to(frameEl, {
        ...
        opacity: 1,
        y: "0%"
    }, "content+=0.3").to(item.preview.DOM.innerElements, {
        ease: "expo",
        startAt: {
            yPercent: 101
        },
...
const closeItem = (item)=>{
    (0, _gsap.gsap).timeline({
        ...
        opacity: 1,
        y: "0%"
    }, "start+=0.3").to(item.preview.DOM.image, {
        y: "101%"
    ...
    }, "start").addLabel("grid", "start+=0.6").to(overlayRows, {
        //ease: 'expo',
        scaleY: 0,
        onComplete: ()=>{
...
},{"gsap":"fPSuC","./item":"8aqVM","./preview":"1Ep93","./utils":"72Dku"}],"fPSuC":[function(require,module,exports) {
...
},{"./gsap-core.js":"05eeC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"8aqVM":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
/**
...
class Item {
     ...
     */ constructor(DOM_el, previewEl){
        ...
        this.DOM.el.addEventListener("mouseenter", ()=>{
            (0, _gsap.gsap).killTweensOf(this.DOM.imageInner);
            (0, _gsap.gsap).to(this.DOM.imageInner, {
                duration: 0.1,
                ease: "power4",
                // scale: 1.2
                scale: 1.3
...
},{"gsap":"fPSuC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1Ep93":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
/**
...
class Preview {
	 ...
	 */ constructor(DOM_el){
        ...
        this.DOM.imageInner = [
            ...this.DOM.el.querySelectorAll(".preview__img-inner")
        ];
        ...
        this.DOM.multiImageWrap = [
            ...this.DOM.el.querySelectorAll(".slider__slide > img")
        ];
        ...
        this.DOM.multiLineWrap.forEach((line)=>this.multiLines.push(new (0, _textLinesReveal.TextLinesReveal)(line)));
    }
}
...
const imagesLoaded = require("8aeb81d251d519ba");
/**
 * Preload images
...
},{"8aeb81d251d519ba":"aYzyZ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"aYzyZ":[function(require,module,exports) {
/*!
 * imagesLoaded v5.0.0
 ...
 */ (function(window1, factory) {
    ...
    module.exports = factory(window1, require("400666cef6b2f09e"));
    else // browser global
...
},{"400666cef6b2f09e":"7rCHo"}],"7rCHo":[function(require,module,exports) {
/**
 * EvEmitter v2.1.1
 * Lil' event emitter
 * MIT License
...
},{}]},["gHDMI","ebWYT"], "ebWYT", "parcelRequired7a2")
